                    ...
                    <form action="{{ route('stores.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <x-form-input label="Store name" name="name" type="text"
                                placeholder="Enter store name" :value="old('name')" error="name" />

                            {{-- email --}}
                            <x-form-input label="Store Email" name="email" type="email"
                                placeholder="Enter store email" :value="old('email')" error="email" />

                            <!-- Store phone -->
                            <x-form-input label="Store phone" name="phones" type="text"
                                placeholder="Enter store phone" :value="old('phones')" error="phones" />

                            <!-- company Name -->
                            <x-form-input label="Company name" name="company_name" type="text"
                                placeholder="Enter company name" :value="old('company_name')" error="company_name" />

                            <!-- capital -->
                            <x-form-input label="Store Capital" name="capital" type="text"
                                placeholder="Enter store capital" :value="old('capital')" error="capital" />

                            <!-- Store address -->
                            <x-form-input label="Store Address" name="address" type="text"
                                placeholder="Enter store address" :value="old('address')" error="address" />

                            <!-- Register Commerce Number -->
                            <x-form-input label="Register Commerce Number" name="register_commerce_number"
                                type="text" placeholder="Enter register commerce number" :value="old('register_commerce_number')"
                                error="register_commerce_number" />

                            <!-- nif -->
                            <x-form-input label="NIF" name="nif" type="text" placeholder="Enter store NIF"
                                :value="old('nif')" error="nif" />


                            <!-- legal_form -->
                            <x-form-input label="Legal Form" name="legal_form" type="number"
                                placeholder="Enter legal form" :value="old('legal_form')" error="legal_form" />
